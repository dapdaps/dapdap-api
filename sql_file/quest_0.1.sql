...
CREATE INDEX "idx_user_reward_claim_account_claim_time" ON "user_reward_claim" ("account_id","claim_time");
...
alter table t_action_record add column "token_in_currency" VARCHAR(255) NULL;
alter table t_action_record add column "token_out_currency" VARCHAR(255) NULL;
alter table t_action_record add column "extra_data" TEXT NULL;
...
alter table t_action add column "extra_data" TEXT NULL;
...
CREATE INDEX "idx_t_action_record_status_gas" ON "t_action_record" ("status","gas");
...
CREATE INDEX "idx_t_action_account_info_chain_status_count" ON "t_action" ("account_info","chain_id","status","count_number");
CREATE INDEX "idx_t_action_chain_title_count" ON "t_action" ("chain_id", "action_title", "count_number");