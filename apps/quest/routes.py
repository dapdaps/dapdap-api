...
async def leaderboard(request: Request, page: int, page_size: int = 10):
    ...
    return success({
        'total_reward': campaign['total_reward'] if campaign['total_reward'] else 0,
        'total_users': campaign['total_users'] if campaign['total_reward'] else 0,
        'total_quest_execution': campaign['total_quest_execution'] if campaign['total_reward'] else 0,
        'data': data,
