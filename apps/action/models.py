...
class Action(Model):
    ...
    action_title =  fields.CharField(max_length=255, null=True)
    action_type =  fields.CharField(max_length=255, null=True)
    action_tokens =  fields.CharField(max_length=255, null=True)
    action_amount =  fields.CharField(max_length=255, null=True)
    account_id =  fields.CharField(max_length=255, null=True)
    account_info =  fields.CharField(max_length=255, null=True)
    template =  fields.CharField(max_length=255, null=True)
    status =  fields.CharField(max_length=1, null=True)
    count_number =  fields.BigIntField(index=True)
    action_network_id = fields.CharField(max_length=255, null=True)
...
class ActionRecord(BaseDBModel):
    ...
    template =  fields.CharField(max_length=255, null=True)
    status =  fields.CharField(max_length=1, null=True)
    action_status =  fields.CharField(max_length=255, null=True)
    tx_id =  fields.CharField(max_length=255, null=True)
    action_network_id = fields.CharField(max_length=255, null=True)
